...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Register or update a user after Google sign-in' }),
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Get total number of registered users (public)' }),
    __metadata("design:type", Function),
